  ...
  return (
    <>
          ...
          <div data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <Link href="/contact" className="bg-yellow-400 font-semibold text-midnight_text px-8 py-4 rounded-full hover:opacity-90">
                Book Free Excise Tax Consultation
              </Link>
      ...
      <section className="bg-white dark:bg-darkmode py-20 px-4">
        <div className="container mx-auto max-w-6xl grid lg:grid-cols-2 grid-cols-1 gap-12 items-start">
          <div data-aos="fade-right" data-aos-duration="1000">
            <span className="bg-section dark:bg-darklight text-primary font-semibold rounded-full px-6 py-2">DOCUMENTATION</span>
            <h2 className="text-midnight_text dark:text-white text-3xl md:text-4xl font-bold leading-tight mt-6">
              Excise Tax Records That Support Compliance
            </h2>
            <p className="text-grey dark:text-white/50 text-lg mt-6">
              Maintaining complete records is essential for Excise Tax compliance. Nafaz helps businesses
              organize documentation related to production, imports, storage, inventory, and sales to meet
              Federal Tax Authority requirements.
            </p>
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-3 mt-8">
              {documentationBenefits.map((item, index) => (
                <span key={index} className="bg-section dark:bg-darklight text-midnight_text dark:text-white text-sm font-medium rounded-md px-4 py-3">
                  ✔ {item}
                </span>
              ))}
            </div>
          </div>
          <div className="bg-section dark:bg-darklight rounded-md shadow-service p-10" data-aos="fade-left" data-aos-duration="1000">
