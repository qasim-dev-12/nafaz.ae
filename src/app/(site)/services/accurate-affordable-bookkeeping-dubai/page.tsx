      ...
      <section className="bg-midnight_text dark:bg-darkmode py-20 md:pt-44 pt-36 px-4">
        <div className="container mx-auto max-w-6xl grid md:grid-cols-2 grid-cols-1 gap-10 items-center">
          <div data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
            <span className="inline-block bg-yellow-400 text-midnight_text font-semibold rounded-full px-6 py-2 mb-6">Affordable Bookkeeping Services in Dubai</span>
            <h1 className="text-white text-4xl md:text-5xl font-bold leading-tight">Accurate and Affordable Bookkeeping in Dubai</h1>
            <p className="text-white/70 text-lg my-7">Professional bookkeeping doesn't have to be expensive. Nafaz provides reliable, affordable bookkeeping services designed for startups, SMEs, and growing businesses across Dubai. Keep your financial records organized, VAT-ready, and fully compliant with expert QuickBooks bookkeeping at transparent monthly prices.</p>
          ...
          <div className="grid grid-cols-2 gap-4" data-aos="fade-left" data-aos-delay="200" data-aos-duration="1000">
            ...
            <div className="col-span-2 aspect-video rounded-md overflow-hidden relative">
              <Image
                src="/images/services-images/07-Accurate and Affordable Bookkeeping in Dubai.png"
                alt="Accurate and Affordable Bookkeeping in Dubai"
                fill
          ...
          <div className="col-span-full flex flex-wrap gap-4 justify-center mt-4">
            <Link href="https://wa.me/971559549922" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-semibold px-8 py-4 rounded-lg hover:bg-[#1ebe57] animate-wobble-left"><Icon icon="ic:baseline-whatsapp" className="text-xl" />WhatsApp Us</Link>
            <Link href="tel:+971559549922" className="flex items-center justify-center gap-2 bg-primary text-white font-semibold px-8 py-4 rounded-lg hover:bg-blue-700 animate-wobble-left"><Icon icon="ic:baseline-call" className="text-xl" />Call Us</Link>
          </div>
        </div>
      </section>
