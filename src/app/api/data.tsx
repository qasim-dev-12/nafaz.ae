...
export const Progress = [
    ...
    { title: 'On-Time Filing Rate', Progress: 100 },
...
export const AccountingServices = [
    {
        icon: '/images/services-images/01-Premier Accounting Services in Dubai.png',
    ...
    {
        icon: '/images/services-images/02-Accounting Services in Abu Dhabi.png',
    ...
    {
        icon: '/images/services-images/03-Accounting Services in Sharjah.png',
    ...
    {
        icon: '/images/services-images/04-Amazon Accounting Services in Dubai.png',
    ...
    {
        icon: '/images/services-images/05-Ecommerce Accounting Services in Dubai.png',
    ...
    {
        icon: '/images/services-images/06-Bookkeeping Firm in Dubai.png',
    ...
    {
        icon: '/images/services-images/07-Accurate and Affordable Bookkeeping in Dubai.png',
    ...
    {
        icon: '/images/services-images/08-Payroll (WPS) Services in Dubai.png',
